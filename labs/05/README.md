...
Try the practice problem first; verify your solutions [here](./files/p1intarr_solution.c).
...
Try the practice problem first; verify your solutions [here](./files/p2intarr_solution.c).
