/*
 * test.c - functions, arrays, pointers, image representation
 * Richard Vaughan 2014
 * 
 * Modified: AL - June 2019
 */
...
int main( int argc, char* argv[] )
{
  ...
  uint8_t* img_Copy = copy( img, imgwidth, imgheight );

  // Flipping the image, left-to-right, like in a mirror.
  flip_horizontal( img_Copy, imgwidth, imgheight );

  printf( "Flip horizontally the image\n" );

  // draw the array as a grey-scale image in the window
  // This function returns after a user clicks or presses a button in the window
  draw_image_grey( img_Copy, imgwidth, imgheight );
  ...
  // Get a copy of original image
  uint8_t* img_another_Copy = copy( img, imgwidth, imgheight );

  // Flipping the image, top-to-bottom.
  flip_vertical( img_another_Copy, imgwidth, imgheight );

  printf( "Flip vertically the image\n" );

  // draw the array as a grey-scale image in the window
  // This function returns after a user clicks or presses a button in the window
  draw_image_grey( img_another_Copy, imgwidth, imgheight );
